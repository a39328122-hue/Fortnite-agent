(() => {
  ...
  const COPY = {
    en: {
      ...
      imageLabel: "IMAGE",
      loadingImage: "Searching Epic images...",
      imageUnavailable: "No Image found\nError 404",
      imageError: "Preview temporarily unavailable.",
      copyJson: "Copy JSON",
    ...
    fr: {
      ...
      imageLabel: "IMAGE",
      loadingImage: "Recherche des images Epic...",
      imageUnavailable: "Aucune image trouvée\nErreur 404",
      imageError: "Aperçu temporairement indisponible.",
    ...
    ar: {
      ...
      imageLabel: "الصورة",
      loadingImage: "جاري البحث عن صور Epic...",
      imageUnavailable: "لم يتم العثور على صورة\nError 404",
      imageError: "المعاينة غير متاحة مؤقتاً.",
      copyJson: "نسخ JSON",
